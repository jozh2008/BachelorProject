...
class Tool:
    ...
    def show_tool_input(self, tool_name):
        ...
        self.write_to_file(input_states, "input_states_metaphlan.txt")
        ...
        self.write_to_file(inputs_opitons, "output_metaphlan.txt")
