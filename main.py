...
def main():
    ...
    gi.get_newest_tool_version_and_id_2("FastQC")
    gi.get_newest_tool_version_and_id("MultiQC")
    gi.get_newest_tool_version_and_id_2("MultiQC")
    gi.get_newest_tool_version_and_id("Filter with SortMeRNA")
    gi.get_newest_tool_version_and_id_2("Filter with SortMeRNA")
    gi.get_newest_tool_version_and_id("MetaPhlAn")
    gi.get_newest_tool_version_and_id_2("MetaPhlAn")
    gi.get_newest_tool_version_and_id("HUMAnN")
    gi.get_newest_tool_version_and_id_2("HUMAnN")
    """
